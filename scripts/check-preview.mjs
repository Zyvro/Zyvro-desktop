...
//    balise dans la fenêtre : le rendu est celui du chat, qui n'utilise jamais
...
const md = readFileSync(path.join(ROOT, "../Zyvro-frontend/src/components/Markdown.tsx"), "utf8")
check("**le rendu n'accepte pas de HTML brut**", /import \{ Markdown \} from "@\/components\/Markdown"/.test(tab) && !/dangerouslySetInnerHTML=/.test(md))
